...
describe('Drag and drop by image', () => {
  ...
  it('Global sqadnd dnd test image', async () => {
    ...
    await browser.robot.image.dragAndDrop({ pathToImage: `./test/specs/pic/test_globalsqa1.png` }, { pathToImage: `./test/specs/pic/test_globalsqa4.png` }, { highLight: TIMEOUT });
    await browser.robot.image.dragAndDrop({ pathToImage: `./test/specs/pic/test_globalsqa2.png` }, { pathToImage: `./test/specs/pic/test_globalsqa4.png` }, { highLight: TIMEOUT });
    await browser.robot.image.dragAndDrop({ pathToImage: `./test/specs/pic/test_globalsqa3.png` }, { pathToImage: `./test/specs/pic/test_globalsqa4.png` }, { highLight: TIMEOUT });
  });
});
